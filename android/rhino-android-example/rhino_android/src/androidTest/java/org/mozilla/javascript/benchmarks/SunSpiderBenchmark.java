...
{
    public static final String TEST_SRC = "benchmarks/sunspider-0.9.1/run.js";
        ...
        throws IOException
    {
        PrintWriter out = new PrintWriter(
            new FileWriter(new File(InstrumentationRegistry.getContext().getFilesDir(), "sunspider.csv"))
        );
