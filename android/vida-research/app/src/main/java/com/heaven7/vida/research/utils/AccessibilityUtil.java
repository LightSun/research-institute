...
public class AccessibilityUtil {
    private static final String ACCESSIBILITY_SERVICE_PATH = TestAccessibilityService.class.getCanonicalName();
    /**
     * 判断是否有辅助功能权限
     *
     * @param context
    ...
    public static boolean isAccessibilitySettingsOn(Context context) {
        ...
        Logger.d("AccessibilityUtil", "isAccessibilitySettingsOn", "serviceStr: " + serviceStr);
