...
import net.thdev.mediacodecexample.utils.MediaUtils;
...
public class AudioDecoderThread {
	...
	public void startPlay(String path) throws IOException {
		...
		MediaFormat oldFormat = MediaUtils.getMediaFormat(mExtractor, MediaUtils.TYPE_AUDIO, path);
		mSampleRate = oldFormat.getInteger(MediaFormat.KEY_SAMPLE_RATE);
		int channel = oldFormat.getInteger(MediaFormat.KEY_CHANNEL_COUNT);
