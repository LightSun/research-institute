...
public class CheapSoundFile {
   ...
   private static final Factory[] sSubclassFactories = new Factory[] {
        new CheapAAC.AACFactory(),
        new CheapAMR.AMRFactory(),
        new CheapMP3.Mp3Factory(),
        new CheapWAV.WavFactory()
    };

    private static final ArrayList<String> sSupportedExtensions = new ArrayList<String>();
