...
package heaven7.coordinatorlayoutbehavior.study1.coordinatorlayout_src;
...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    public CoordinatorLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //window insets (https://medium.com/google-developers/why-would-i-want-to-fitssystemwindows-4e26d9ce1eec)
        setupForInsets();
        // 设置层级关系监听
