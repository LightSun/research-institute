...
public class MergeImageTest {
    ...
    public void testWrite(){
        ...
        Matrix2<Integer> mat1 = IMAGE_READER.read(file).getMat();
    ...
    public void testMergeColumn(){
        ...
        Matrix2<Integer> mat1 = IMAGE_READER.read(imgs[0]).getMat();
        Matrix2<Integer> mat2 = IMAGE_READER.read(imgs[1]).getMat();
